        ...
        <el-card shadow="hover" class="main-card">
            <template #header>
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <h2 style="margin:0; color: var(--qa-heading-color);">存提差同比</h2>
                ...
                <el-collapse-item v-for="list in allLists" :key="list._id" :name="list._id">
                    ...
                    <el-table
                        ...
                        <el-table-column label="昨日-存提差" min-width="120">
                            <template #default="scope">
                                <span v-if="scope.row.historicalYesterday === null" class="field-missing">⚠ 未抓到</span>
                                <el-input-number v-else v-model="scope.row.historicalYesterday" :controls="false" size="small" style="width:100%" />
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column label="上周-存提差" min-width="120">
                            <template #default="scope">
                                <span v-if="scope.row.historicalLastWeek === null" class="field-missing">⚠ 未抓到</span>
                                <el-input-number v-else v-model="scope.row.historicalLastWeek" :controls="false" size="small" style="width:100%" />
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column label="上月-存提差" min-width="120">
                            <template #default="scope">
                                <span v-if="scope.row.historicalLastMonth === null" class="field-missing">⚠ 未抓到</span>
                                <el-input-number v-else v-model="scope.row.historicalLastMonth" :controls="false" size="small" style="width:100%" />
                            </template>
                        </el-table-column>
                        ...
                        <!-- 12. < 昨日（RCSQA） -->
                        <el-table-column label="< 昨日（RCSQA）" min-width="120" align="center">
                            <template #default="scope">
                        ...
                        <!-- 13. < 上周同天（RCSQA） -->
                        <el-table-column label="< 上周同天（RCSQA）" min-width="140" align="center">
                            <template #default="scope">
                        ...
                        <!-- 14. < 上月同天（RCSQA） -->
                        <el-table-column label="< 上月同天（RCSQA）" min-width="140" align="center">
                            <template #default="scope">
                        ...
                        <el-table-column width="80" align="center">
                            ...
                            <template #default="scope">
                                <el-icon
                                    v-if="calcLogicMatch(list.records.indexOf(scope.row), list.records, getCfg(list))"
