        ...
        <el-card shadow="hover" class="main-card">
            <template #header>
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <h2 style="margin:0; color: var(--qa-heading-color);">{{ pageTitle }}</h2>
                ...
                <el-collapse-item v-for="list in allLists" :key="list._id" :name="list._id">
                    ...
                    <el-table
                        ...
                        <el-table-column width="115" align="center">
                            ...
                            <template #default="scope">
                                <el-tag v-if="typeId !== 9" :type="getNormalResult(scope.row, list) === 'TRUE' ? 'success' : 'danger'" size="small">
                        ...
                        <el-table-column width="80" align="center">
                            ...
                            <template #default="scope">
                                <el-icon
                                    v-if="checkLogicMatch(scope.row, list.records.indexOf(scope.row), list)"
                                    color="var(--qa-pass)" size="22">
                                    <CircleCheck />
                                </el-icon>
                                <el-icon v-else color="var(--qa-fail)" size="22">
                                    <CircleClose />
                                </el-icon>
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column label="操作" width="110" align="center" fixed="right">
                            <template #default="scope">
                                <el-button
                                    ...
                                    link
                                    @click="scope.row.ignored = !scope.row.ignored">
...
const getNormalResult = (row, list) => calcNormalResult(row, getCfg(list), typeId)
